...
public class MeshCutSide
{
    ...
    public void AddTriangle(int p1, int p2, int p3, int submesh, ref Mesh victim_mesh)
    {
            ...
            for (int i = 0; i < indices.Length; i += 3)
            {
                ...
                if (sides[0] == sides[1] && sides[0] == sides[2])
                {
                    if (sides[0])
                    {
                        ...
                        left_side.AddTriangle(p1, p2, p3, sub, ref victim_mesh);
                    }
                    else
                    {
                        right_side.AddTriangle(p1, p2, p3, sub, ref victim_mesh);
                    }
                }
                else
                {
